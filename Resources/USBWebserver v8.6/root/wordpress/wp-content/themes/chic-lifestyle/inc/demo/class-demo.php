 ...
 * Demo class
 *
 * @package Chic_Lifestyle
 */

if ( ! class_exists( 'Chic_Lifestyle_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Chic_Lifestyle_Demo {

		/**
		 * Singleton instance of Chic_Lifestyle_Demo.
		 *
		 * @var Chic_Lifestyle_Demo $instance Chic_Lifestyle_Demo instance.
		 */
		...
		/**
		 * Main Chic_Lifestyle_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Chic_Lifestyle_Demo ) ) {
				self::$instance = new Chic_Lifestyle_Demo();
