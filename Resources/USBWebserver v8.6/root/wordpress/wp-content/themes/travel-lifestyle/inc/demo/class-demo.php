...
if ( ! class_exists( 'Travel_Lifestyle_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Travel_Lifestyle_Demo {

		/**
		 * Singleton instance of Travel_Lifestyle_Demo.
		 *
		 * @var Travel_Lifestyle_Demo $instance Travel_Lifestyle_Demo instance.
		 */
		...
		/**
		 * Main Travel_Lifestyle_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Travel_Lifestyle_Demo ) ) {
				self::$instance = new Travel_Lifestyle_Demo();
